...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://88632676066635",
...
local v15 = v14:CreateWindow({
    Title = "tui đẹp zai vc hub",
    SubTitle = "Blox Fruit free /tao đẹp zai vc",
    TabWidth = 160,
    Theme = "Dark",
    Acrylic = false,
...
function CheckLevel()
    ...
    if Sea1 then
        ...
        elseif ((v197 == 10) or (v197 <= 474) or (SelectMonster == "God's Guard")) then
            ...
            if (_G.AutoLevel and ((CFrameMon.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 3000)) then
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("req
